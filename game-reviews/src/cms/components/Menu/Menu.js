...
import { faFolderOpen, faRightFromBracket, faUser, faFolderTree, faNewspaper, faGamepad } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={`${styles.menu_container}`}>
            <div>
                ...
                <ul>
                    ...
                    <li><button onClick={() => onMenuClick('katalogi')}><FontAwesomeIcon icon={faFolderOpen} />Katalogi</button></li>
                </ul>
            </div>
            <div>
                <h2>Moduły</h2>
